...
namespace UltimateCustomRun.Items.VoidGreens
{
    public class Tentabauble : ItemBase
    {
        ...
        public override string DescText => "<style=cIsUtility>" + Chance + "%</style> <style=cStack>(+" + Chance + "% per stack)</style> chance on hit to <style=cIsDamage>root</style> enemies for <style=cIsUtility>1s</style> <style=cStack>(+1s per stack)</style>. <style=cIsVoid>Corrupts all Chronobaubles</style>.";
