namespace WellRoundedBalance.Gamemodes.Eclipse
{
    internal class ZChangeDescriptions : GamemodeBase<ZChangeDescriptions>
    {
        ...
        public override void Hooks()
        {
            ...
            LanguageAPI.Add("ECLIPSE_1_DESCRIPTION", e1prefix + e1);
            LanguageAPI.Add("ECLIPSE_2_DESCRIPTION", e1prefix + e1 + e2);
            LanguageAPI.Add("ECLIPSE_3_DESCRIPTION", e1prefix + e1 + e2 + e3);
            LanguageAPI.Add("ECLIPSE_4_DESCRIPTION", e1prefix + e1 + e2 + e3 + e4);
            LanguageAPI.Add("ECLIPSE_5_DESCRIPTION", e1prefix + e1 + e2 + e3 + e4 + e5);
            LanguageAPI.Add("ECLIPSE_6_DESCRIPTION", e1prefix + e1 + e2 + e3 + e4 + e5 + e6);
            LanguageAPI.Add("ECLIPSE_7_DESCRIPTION", e1prefix + e1 + e2 + e3 + e4 + e5 + e6 + e7);
            LanguageAPI.Add("ECLIPSE_8_DESCRIPTION", e8prefix + e1prefix + e1 + e2 + e3 + e4 + e5 + e6 + e7 + e8);
        }
    }
}