...
namespace WellRoundedBalance.Mechanic.HoldoutZone
{
    internal class PillarRewards : GlobalBase
    {
        ...
        private PickupPickerController.Option[] GenerateOptions() {
            ...
            pearl.pickupIndex = Run.instance.treasureRng.RangeFloat(0, 10) > 2 ? RoR2Content.Items.Pearl.GetPickupIndex() : RoR2Content.Items.ShinyPearl.GetPickupIndex();

            PickupPickerController.Option lunar = new();
            lunar.available = true;
            lunar.pickupIndex = Run.instance.availableLunarItemDropList[Run.instance.treasureRng.RangeInt(0, Run.instance.availableLunarItemDropList.Count - 1)];

            PickupPickerController.Option green = new();
            green.available = true;
            green.pickupIndex = Run.instance.availableTier2DropList[Run.instance.treasureRng.RangeInt(0, Run.instance.availableTier2DropList.Count - 1)];
