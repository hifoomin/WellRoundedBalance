namespace WellRoundedBalance.Equipment
{
    public class TheCrowdfunder : EquipmentBase
    {
        ...
        public override string DescText => "Wind up a continuous barrage that shoots up to <style=cIsDamage>10 times per second</style>, dealing <style=cIsDamage>100% damage per shot</style> (extremely low). Costs $1 per bullet. Cost increases with level.";
        ...
        private void Changes(On.EntityStates.GoldGat.GoldGatFire.orig_OnEnter orig, EntityStates.GoldGat.GoldGatFire self)
        {
            ...
            EntityStates.GoldGat.GoldGatFire.maxFireFrequency = 10f;
