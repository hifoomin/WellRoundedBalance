// new version commented out below, doesnt really work, but its cool lol
...
namespace WellRoundedBalance.Items.Reds
{
    public class NkuhanasOpinion : ItemBase<NkuhanasOpinion>
    {
        ...
        {
            self.procCoefficient = procCoefficient * Items.Greens._ProcCoefficients.globalProc;
            orig(self);
        }
...
namespace WellRoundedBalance.Items.Reds
{
    public class NkuhanasOpinion : ItemBase<NkuhanasOpinion>
    {
        ...
        public override void Hooks()
        {
            ...
            projectileDotZone.overlapProcCoefficient = procCoefficient * Items.Greens._ProcCoefficients.globalProc;
           ...
           //  projectileOverlapAttack.overlapProcCoefficient = procCoefficient * Items.Greens._ProcCoefficients.globalProc;
