...
namespace WellRoundedBalance.Items.Greens
{
    public class Bandolier : ItemBase
    {
        ...
        public override string DescText => "<style=cIsUtility>" + (d(1 - (1 / (Mathf.Pow(baseValue + 1, exponent))))) + "</style> <style=cStack>(+" + (d(1 - (1 / (Mathf.Pow(baseValue + 2, exponent))))) + " per stack)</style> chance on kill to drop an ammo pack that <style=cIsUtility>resets all skill cooldowns</style>.";
