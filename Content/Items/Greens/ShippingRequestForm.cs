...
namespace WellRoundedBalance.Items.Greens
{
    public class ShippingRequestForm : ItemBase
    {
        ...
        public override string DescText => "A <style=cIsUtility>delivery</style> containing 2 items (73%/<style=cIsHealing>25%</style>/<style=cIsHealth>2%</style>) will appear in a random location <style=cIsUtility>on each stage</style>. <style=cStack>(Increases rarity chances of the items per stack).</style>";
        ...
        private void Changes()
        {
            ...
            shipDt.tier1Weight = 0.73f;
            shipDt.tier2Weight = 0.25f;
