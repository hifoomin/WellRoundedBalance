...
namespace WellRoundedBalance.Items.Whites
{
    public class BundleOfFireworks : ItemBase
    {
        ...
        public override string DescText => "Activating an interactable <style=cIsDamage>launches 6 <style=cStack>(+6 per stack)</style> fireworks</style> that deal <style=cIsDamage>300%</style> base damage.";
