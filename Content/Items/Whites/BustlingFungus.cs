...
namespace WellRoundedBalance.Items.Whites
{
    public class BustlingFungus : ItemBase<BustlingFungus>
    {
        ...
        [ConfigField("Percent Healing", "Decimal. Formula for Healing Per Second: (Percent Healing + Percent Healing Per Stack * (Bustling Fungus - 1)) / Healing Interval", 0.01f)]
        public static float percentHealing;

        [ConfigField("Percent Healing Per Stack", "Decimal. Formula for Healing Per Second: (Percent Healing + Percent Healing Per Stack * (Bustling Fungus - 1)) / Healing Interval", 0.01f)]
