...
namespace WellRoundedBalance.Items.VoidWhites
{
    public class WeepingFungus : ItemBase
    {
        ...
        public override string DescText => "<style=cIsHealing>Heals</style> for <style=cIsHealing>1.5%</style> <style=cStack>(+1.5% per stack)</style> of your <style=cIsHealing>health</style> every second <style=cIsUtility>while sprinting</style>. <style=cIsVoid>Corrupts all Bustling Fungi</style>.";
