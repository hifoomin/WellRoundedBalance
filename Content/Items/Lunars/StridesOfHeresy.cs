...
namespace WellRoundedBalance.Items.Lunars
{
    public class StridesOfHeresy : ItemBase<StridesOfHeresy>
    {
        ...
        private void Changes()
        {
            ...
            LanguageAPI.Add("SKILL_LUNAR_UTILITY_REPLACEMENT_DESCRIPTION", "Dash, <style=cIsHealing>healing</style> for <style=cIsHealing>5% of your maximum health</style>. Lasts <style=cIsUtility>1</style> <style=cStack>(+0.5 per stack)</style> seconds, then <style=cIsHealing>heals</style> for <style=cIsHealing>10% of your maximum health</style>.");
        }
    }
